...
import { Folder, HelpCircle, Home, Library, Search } from "lucide-react";
    ...
    <section className="py-40 w-full h-screen">
      <Container>
        ...
        <div className="flex justify-between gap-8 px-80 mt-10">
          ...
          >
            <div className="flex flex-col items-center gap-2">
              <button className="bg-indigo-200 rounded-md p-2 w-fit">
                <Folder className="text-indigo-400 h-8 w-8 " />
              </button>

              <span className="text-slate-700 text-xl">Blog</span>
            </div>
          </Link>
        </div>
      </Container>
